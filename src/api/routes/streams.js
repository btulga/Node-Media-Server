...
module.exports = (context) => {
  ...
  router.post('/trans-mp4', streamController.postMp4StreamTrans.bind(context));
  router.post('/start-record', streamController.postMp4StreamTrans.bind(context));
  router.post('/stop-record', streamController.stopStreamRecord.bind(context));
